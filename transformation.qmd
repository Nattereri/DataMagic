...
Summary statistics for the `Conductivity` for all WTW is shown in @tbl-wtwcond and to make the table easier to read the median value highlighted in a graduated scale.
